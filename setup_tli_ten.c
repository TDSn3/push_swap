...
/*   Updated: 2022/06/19 10:27:03 by tda-silv         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	d->tli_a_ten = NULL;
	d->tli_a_ten = tli_setup_a_ten(d, d->tli_a_ten, d->stock_tli_a_ten);
	...
	d->tli_b_ten = NULL;
	d->tli_b_ten = tli_setup_b_ten(d, d->tli_b_ten, d->stock_tli_b_ten);
