...
/*   Updated: 2022/09/05 16:36:49 by tda-silv         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int				if_sorted_da(t_data *d, t_sub_lst *copy_sl);
void			make_all_oper_a(t_double_lst *dl, t_data *d);
void			make_all_oper_da(t_double_lst *dl, t_data *d);
void			sort_first_five_a(t_data *d);
void			sort_first_five_da(t_data *d);
