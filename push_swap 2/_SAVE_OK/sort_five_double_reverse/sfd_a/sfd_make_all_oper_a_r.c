...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   sfd_make_all_oper_a_r.c                            :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: tda-silv <tda-silv@student.42.fr>          +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/09/09 12:39:27 by tda-silv          #+#    #+#             */
/*   Updated: 2022/09/09 12:39:42 by tda-silv         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	sfd_make_all_oper_a_r(t_double_lst *dl, t_data *d, t_sub_lst **lst_oper)
{
	...
	while (copy_sl)
	{	
		if (sfd_if_sorted_a_r(d, copy_sl, lst_oper))
			return ;
	...
	sfd_make_all_oper_a_r(dl, d, lst_oper);
}
