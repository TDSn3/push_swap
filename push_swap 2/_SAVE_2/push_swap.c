...
/*   Updated: 2022/09/08 19:04:21 by tda-silv         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//	printf("\n\n");
	...
	while (nb_sort < 9)
	{
		...
		{
			if (pos_in_stack(d->stack_a, d->size_a, list_a->content) > d->size_a / 2)
			{
		...
		{			
			if (pos_in_stack(d->stack_a, d->size_a, list_b->content) > d->size_a / 2)
			{
...
void	fusion_part_two(t_data *d, t_tli *list_nb_sorted)
{
	if (find_pos_nb_sort(d, list_nb_sorted) > d->size_a / 2)
	{
